...
addon_info = {
	...
	"addon_name": "unitConverter",
	# Add-on summary, usually the user visible name of the addon.
	# Translators: Summary for this add-on
	# to be shown on installation and add-on information found in Add-ons Manager.
	"addon_summary": _("NVDA unit converter"),
	# Add-on description
...
"""),
	# version
	"addon_version": "0.3.52",
	# Author(s)
	"addon_author": "Nibar Ahmed <nibarahmed0@gmail.com>",
	# URL for the add-on documentation support
	"addon_url": "https://github.com/nibarAhmed/NVDAUnitConverter",
	# URL for the add-on repository where the source code can be found
	"addon_sourceURL": "https://github.com/nibarAhmed/NVDAUnitConverter",
...
pythonSources = [os.path.join("addon", "globalPlugins", "NVDAUnitConverter", "*.py")]
